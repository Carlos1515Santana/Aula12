        ...
        <body>
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" name="populacao" id="populacao" placeholder="População do país" value="${pais.getPopulaçao()}">
                </div>
                    ...
                    <input type="text" class="form-control" name="area" id="area" placeholder="Área do país" value="${pais.area}">
                        ...
                        <div id="actions" class="row">
                            <div class="col-md-12">
                                ...
                                <a href="ListaDePais.jsp" class="btn btn-default">Cancelar</a>
                            </div>
                        </div>
                    </form>
                </div>
