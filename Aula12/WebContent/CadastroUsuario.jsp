    ...
    <div id="main" class="container">
       ...
       <!-- Formulario de Login -->
        <form action="ServletController" method="post">
				...
				<div class="row col-md-12">
					<button type="submit" class="btn btn-primary" name="command" value="CadastrarUsuario"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span> Cadastrar Usuario</button>
				</div>
			</form>    
			</div>
