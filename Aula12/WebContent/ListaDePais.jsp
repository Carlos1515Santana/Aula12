...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <body>
            ...
            <div id="main" class="container">
                ...
                <button class="btn btn-primary" type="submit" name="command" value="ListaDePais">
                            ...
                            <tbody>
          					<c:forEach var="pais" items="${lista }">
                                       <tr>
                                            ...
                                            <td class="actions">
                                                <a class="btn btn-success btn-xs" href="ServletController?command=Visualizar&id=${pais.id }">Visualizar</a>
                                                <a class="btn btn-warning btn-xs" href="ServletController?command=EditarPais&id=${pais.id }">Editar</a>
